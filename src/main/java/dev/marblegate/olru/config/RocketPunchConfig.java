...
public class RocketPunchConfig {
    ...
    RocketPunchConfig(ModConfigSpec.Builder builder) {
        ...
        wallBonusDamage = builder
                ...
                .defineInRange("wallBonusDamage", 1.5, 0.0, 1000.0);
